...
class NotificationTemplate extends Model
{
    ...
    static $notificationTemplateAssignSetting = [
        'admin' => ['new_comment_admin', 'support_message_admin', 'support_message_replied_admin', 'promotion_plan_admin', 'payout_request_admin',
            ...
            'user_wallet_charge', 'new_user_payout_request', 'new_offline_payment_request','submit_verification_doc_payment','course_approve','certificate_request_send'
        ],
        ...
        'certificate_request_approved' ,'certificate_request_rejected'
        ],

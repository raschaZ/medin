            ...
            <div class="col-12 @if($webinar->isWebinar()) col-md-6 @endif">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="duration" value="{{ (!empty($webinar) and !empty($webinar->duration)) ? $webinar->duration : old('duration') }}" class="form-control @error('duration')  is-invalid @enderror" placeholder="mins"/>
                        @error('duration')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>

...
(function ($) {
  ...
  * */
  ...
  $('body').on('click', '.notification-action', function (e) {
    ...
    var href = $(this).attr('href');
    var title = $(this).attr('data-title') || notificationAlertHint;
    var confirm = $(this).attr('data-confirm') || notificationAlertConfirm;
    var cancel = $(this).attr('data-cancel') || notificationAlertCancel;
    ...
    var html = `
        <div class="">
            <p class="">${title}</p>
            <div class="mt-30 d-flex align-items-center justify-content-center">
                <button type="button" id="swlNotify" data-href="${href}" class="btn btn-sm btn-primary">
                    ${confirm}
                </button>
    ...
    $('body').on('click', '#swlNotify', function () {
        var notifyHref = $(this).attr('data-href');
        
        // Redirect or perform AJAX notification logic here
  ...
  $('body').on('click', '#swlDelete', function (e) {
    ...
    $.get(href, function (result) {
      if (result && result.code === 200) {
        ...
        console.error("AJAX GET error result:", result);
        Swal.fire({

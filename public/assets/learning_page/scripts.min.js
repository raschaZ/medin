...
(function ($) {
  ...
  $('body').on('click', '.certificate-item', function () {
    ...
    if (result && result !== '') {
      ...
      alert('Before downloading the certificate, make sure to mark your attendance and review the course content.');
    }
  });
  $('body').on('click', '.attendance-tab-item', function () {
    var $this = $(this);
    $('.course-certificate-item').removeClass('active');
    $('.certificate-item').removeClass('active');
    $('.tab-item').removeClass('active');
    ...
    if (result && result !== '') {
      ...
      alert('Before you can take the quiz, make sure to mark your attendance and review the course content.');
    }
  });
  $('body').on('click', '.course-certificate-item', function () {
    ...
    if (id && id !== '') {
      ...
      alert('You must mark your attendance and review the course content before downloading the certificate.');
    }
  });
